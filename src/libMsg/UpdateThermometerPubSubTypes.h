...
namespace detail {
    ...
    template struct UpdateThermometer_rob<UpdateThermometer_f, &UpdateThermometer::m_mps>;
...
private:
    ...
    {
        return 4ULL == (detail::UpdateThermometer_offset_of<UpdateThermometer, detail::UpdateThermometer_f>() + sizeof(int32_t));
