...
/*!
 * @file UpdateHygrometerTypeObject.cpp
...
void registerUpdateHygrometerTypes()
{
    static std::once_flag once_flag;
    std::call_once(once_flag, []()
            {
                TypeObjectFactory *factory = TypeObjectFactory::get_instance();
                factory->add_type_object("UpdateHygrometer", GetUpdateHygrometerIdentifier(true),
                GetUpdateHygrometerObject(true));
                factory->add_type_object("UpdateHygrometer", GetUpdateHygrometerIdentifier(false),
                GetUpdateHygrometerObject(false));

            });
}

const TypeIdentifier* GetUpdateHygrometerIdentifier(bool complete)
{
    const TypeIdentifier * c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("UpdateHygrometer", complete);
    if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
    {
        return c_identifier;
    }

    GetUpdateHygrometerObject(complete); // Generated inside
    return TypeObjectFactory::get_instance()->get_type_identifier("UpdateHygrometer", complete);
}

const TypeObject* GetUpdateHygrometerObject(bool complete)
{
    const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("UpdateHygrometer", complete);
    ...
    {
        return GetCompleteUpdateHygrometerObject();
    }
    //else
    return GetMinimalUpdateHygrometerObject();
}

const TypeObject* GetMinimalUpdateHygrometerObject()
{
    const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("UpdateHygrometer", false);
    if (c_type_object != nullptr)
    {
        return c_type_object;
    }
    ...
    TypeObjectFactory::get_instance()->add_type_object("UpdateHygrometer", &identifier, type_object);
    delete type_object;
    return TypeObjectFactory::get_instance()->get_type_object("UpdateHygrometer", false);
}

const TypeObject* GetCompleteUpdateHygrometerObject()
{
    const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("UpdateHygrometer", true);
    ...
    // Header
    type_object->complete().struct_type().header().detail().type_name("UpdateHygrometer");
    // TODO inheritance
    ...
    TypeObjectFactory::get_instance()->add_type_object("UpdateHygrometer", &identifier, type_object);
    delete type_object;
    return TypeObjectFactory::get_instance()->get_type_object("UpdateHygrometer", true);
}
