...
#ifndef _FAST_DDS_GENERATED_IMAGE_PUBSUBTYPES_H_
#define _FAST_DDS_GENERATED_IMAGE_PUBSUBTYPES_H_
...
public:
    ...
    eProsima_user_DllExport ~ImagePubSubType() override;
...
#endif // _FAST_DDS_GENERATED_IMAGE_PUBSUBTYPES_H_
