...
#ifndef _FAST_DDS_GENERATED_MSGTMP_H_
#define _FAST_DDS_GENERATED_MSGTMP_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(MsgTmp_SOURCE)
#define MsgTmp_DllAPI __declspec( dllexport )
#else
#define MsgTmp_DllAPI __declspec( dllimport )
#endif // MsgTmp_SOURCE
#else
#define MsgTmp_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define MsgTmp_DllAPI
#endif // _WIN32
...
#endif // _FAST_DDS_GENERATED_MSGTMP_H_