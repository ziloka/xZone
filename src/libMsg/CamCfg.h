...
#ifndef _FAST_DDS_GENERATED_CAMCFG_H_
#define _FAST_DDS_GENERATED_CAMCFG_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(CAMCFG_SOURCE)
#define CAMCFG_DllAPI __declspec( dllexport )
#else
#define CAMCFG_DllAPI __declspec( dllimport )
#endif // CAMCFG_SOURCE
#else
#define CAMCFG_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define CAMCFG_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure CamCfg defined by the user in the IDL file.
 * @ingroup CamCfg
 */
class CamCfg
{
public:
     ...
     */
    eProsima_user_DllExport CamCfg();
     ...
     * @param x Reference to the object CamCfg that will be copied.
     */
    eProsima_user_DllExport CamCfg(
            const CamCfg& x);
     ...
     * @param x Reference to the object CamCfg that will be copied.
     */
    eProsima_user_DllExport CamCfg& operator =(
            const CamCfg& x);
     ...
     * @param x CamCfg object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_CAMCFG_H_
