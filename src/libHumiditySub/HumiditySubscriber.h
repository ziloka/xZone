...
#ifndef HUMIDITYSUBSCRIBER_H_
#define HUMIDITYSUBSCRIBER_H_
...
class HumiditySubscriber
{
public:

    HumiditySubscriber();

    virtual ~HumiditySubscriber();
...
private:
    ...
    public:
        ...
        SubListener()
            ...
            , file_(std::ofstream())
        {
            file_.open("humidity_pubsub_data.csv");
            std::cout << "Opened humidity_pubsub_data.csv.. appending to file" << std::endl;
