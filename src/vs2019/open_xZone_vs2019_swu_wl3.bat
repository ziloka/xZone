...
set APP_SRC=C:\Users\wus1\Projects\swu-personal\xZone\src
set APP_BUILD_INT=C:\Users\wus1\Projects\swu-personal\xZone\build-vs2019-x64\int
set APP_BUILD_BIN=C:\Users\wus1\Projects\swu-personal\xZone\build-vs2019-x64\bin

"C:\Program Files (x86)\Microsoft Visual Studio\2019\Professional\Common7\IDE\devenv.exe" %APP_SRC%\vs2019\xZone_vs2019.sln
