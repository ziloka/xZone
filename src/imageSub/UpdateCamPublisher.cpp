...
UpdateCamPublisher::UpdateCamPublisher()
...
void UpdateCamPublisher::PubListener::on_publication_matched(
...
void UpdateCamPublisher::runThread(
    uint32_t samples,
    uint32_t sleep)
{
...
std::thread UpdateCamPublisher::run(uint32_t samples, uint32_t sleep)
{
    stop_ = false;
...
bool UpdateCamPublisher::publish(bool waitForListener)
{
