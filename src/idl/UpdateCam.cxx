...
#define CfgCam_max_cdr_typesize 560ULL;
#define CfgCam_max_key_cdr_typesize 0ULL;
...
bool CfgCam::operator ==(
        const CfgCam& x) const
{
...
size_t CfgCam::getMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return CfgCam_max_cdr_typesize;
}

size_t CfgCam::getCdrSerializedSize(
        const CfgCam& data,
        size_t current_alignment)
{
    (void)data;
 ...
 */
const std::string& CfgCam::rtspUrl() const
{
    return m_rtspUrl;
}
 ...
 */
int32_t CfgCam::detPyrLev() const
{
    return m_detPyrLev;
}
 ...
 */
int32_t CfgCam::detMethodId() const
{
 ...
 */
int32_t CfgCam::detNetworkId() const
{
 ...
 */
int32_t CfgCam::detFrmsToSkip() const
{
 ...
 */
void CfgCam::mp4LocationAndPrefix(
 ...
 */
const std::string& CfgCam::mp4LocationAndPrefix() const
{
 ...
 */
std::string& CfgCam::mp4LocationAndPrefix()
{
    return m_mp4LocationAndPrefix;
}


size_t CfgCam::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return CfgCam_max_key_cdr_typesize;
}

bool CfgCam::isKeyDefined()
{
    return false;
}

void CfgCam::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
}
