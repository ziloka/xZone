...
/*!
 * @brief This class represents the structure CfgCam defined by the user in the IDL file.
 * @ingroup UpdateCam
 */
class CfgCam
{
public:
     ...
     */
    eProsima_user_DllExport CfgCam();
     ...
     * @param x Reference to the object CfgCam that will be copied.
     */
    eProsima_user_DllExport CfgCam(
            const CfgCam& x);
     ...
     * @param x Reference to the object CfgCam that will be copied.
     */
    eProsima_user_DllExport CfgCam& operator =(
            const CfgCam& x);
     ...
     * @param x CfgCam object to compare.
     */
