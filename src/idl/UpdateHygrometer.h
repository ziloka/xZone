...
/*!
 * @brief This class represents the structure CfgHygrometer defined by the user in the IDL file.
...
public:
     ...
     */
    eProsima_user_DllExport CfgHygrometer();
     ...
     * @param x Reference to the object CfgHygrometer that will be copied.
     */
    eProsima_user_DllExport CfgHygrometer(
     ...
     * @param x Reference to the object CfgHygrometer that will be copied.
     */
    eProsima_user_DllExport CfgHygrometer& operator =(
            const CfgHygrometer& x);
     ...
     * @param x CfgHygrometer object to compare.
     */
